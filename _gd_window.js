...
class __gd_window{
    constructor(htmlBlockElementToMove, boundingBlock = document.body,
        default_z_index = -1, moving_z_index = 1){
            ...
            this.htmlBlockElementToMove.addEventListener("transitionend",this.refreshGeometry);
            this.mountControls();
    }
    ...
    refreshGeometry(){
        ...
        this.maxY = this.boundingBlock.offsetHeight - this.htmlBlockElementToMove_OffsetHeight;
        this.maxX = this.boundingBlock.offsetWidth - this.htmlBlockElementToMove_OffsetWidth;
    ...
    mouseMove(event){
        this.top = event.pageY - this.offsetTopLeft.top - this._mouseDownPositionY;
        this.left = event.pageX - this.offsetTopLeft.left - this._mouseDownPositionX;
        this.limitTopLeft();
    ...
    size_min(){
        if(this._size != "mini"){
            this._size = "mini";
            this.movingDiv.addEventListener("mousedown", this.mouseDown);
            this.htmlBlockElementToMove.style.height = "25%";
            this.htmlBlockElementToMove.style.width = "25%";
    ...
    size_half(){
        if(this._size != "half"){
            ...
            this.htmlBlockElementToMove.style.height = "100%";
            this.htmlBlockElementToMove.style.width = "50%";
            this.refreshGeometry();
        }
    }
    size_full(){
        if(this._size != "full"){
            ...
            this.htmlBlockElementToMove.style.left = "0px";
            this.htmlBlockElementToMove.style.height = "100%";
            this.htmlBlockElementToMove.style.width = "100%";
            this.refreshGeometry();
        }
    }
